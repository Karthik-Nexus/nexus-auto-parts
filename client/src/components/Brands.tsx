            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-10">
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        At Nexus Used Auto Parts LLC, we offer high quality used parts sourced from some of the most trusted and best-selling automotive brands in the industry.
                    </p>
                </div>
            </div>
