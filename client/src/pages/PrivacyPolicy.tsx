        ...
        <div className="min-h-screen bg-neutral-50 font-sans text-slate-800 overflow-x-hidden w-full max-w-full">
            ...
            <section className="relative py-16 md:py-20 bg-gradient-to-b from-slate-900 to-slate-800">
                <div className="relative w-full px-4 z-10 text-center text-white space-y-4">
                    ...
                    <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto">
                        Nexus Used Auto Parts LLC values your privacy and is committed to protecting your personal information
                    </p>
                </div>
            </section>
            ...
            <main className="w-full px-4 py-12 lg:py-16 max-w-4xl mx-auto space-y-8">
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <p className="text-slate-600">
                            When you request a part, place an order, or communicate with Nexus Used Auto Parts LLC, we may collect the following information:
                        </p>
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <ul className="space-y-3 text-slate-600">
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                                Nexus Used Auto Parts LLC owns and controls the information you provide to us
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <ul className="space-y-2 text-slate-600">
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                                Only authorized Nexus Used Auto Parts LLC personnel have access to personal data
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <p className="text-slate-600">
                            Nexus Used Auto Parts LLC may update this Privacy Policy from time to time to reflect operational, legal, or regulatory changes.
                        </p>
                        <ul className="space-y-2 text-slate-600">
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                ...
                <Card className="border-none shadow-lg bg-slate-900 text-white">
                    <CardContent className="p-6 text-center">
                        ...
                        <p className="mb-2">
                            If you have questions or concerns regarding this Privacy Policy or your personal information, please contact Nexus Used Auto Parts LLC through our official communication channels.
                        </p>
