...
export default function AbsModule() {
    return (
            ...
            <section className="relative min-h-[400px] md:h-[600px] flex items-center justify-center overflow-hidden py-16 md:py-0">
                ...
                <div className="relative w-full px-4 z-10 text-center text-white space-y-4 md:space-y-6">
                    <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight drop-shadow-lg px-2">
                        ABS Modules<br />
                        <span className="text-primary-foreground">Safety-Critical, Tested</span>
                    </h1>
                    <p className="text-sm sm:text-base md:text-xl text-gray-200 max-w-2xl mx-auto font-light leading-relaxed px-4">
                        ABS modules are not gamble parts. Ours are inspected for corrosion and failure points.
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
                    ...
                    <div className="lg:col-span-1 lg:order-2">
                        <div className="lg:sticky lg:top-28 space-y-4 lg:space-y-6">
                            <HeroSearchTool defaultPart="ABS Module" />
                            ...
                            <div className="bg-white p-4 lg:p-6 rounded-xl shadow-lg border border-slate-100 text-center">
                                ...
                                <p className="text-xs lg:text-sm text-slate-500 mb-2 lg:mb-4">Our ASE Certified pros can help you find the exact ABS module match.</p>
                                ...
                                <div className="flex flex-col gap-4 lg:gap-6">
                                    <div className="flex items-center gap-3 lg:gap-4">
                                        ...
                                        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-slate-900">
                                            Why Buy ABS Modules from Nexus?
                                        </h2>
                                    </div>
                                    <p className="text-slate-600 text-sm lg:text-base leading-relaxed">
                                        ABS modules are removed from functioning vehicles, inspected for corrosion, connector damage, and fault-prone failure points. We ensure safety-critical parts are properly tested.
                                    </p>
                                    <h3 className="text-base lg:text-xl font-bold text-slate-800">Why Our ABS Modules</h3>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 lg:gap-3">
                                        {[
                                            "OEM electronic testing",
                                            "Connector & pin inspection",
                                            "VIN-verified compatibility",
                                            "No rebuilt guesswork",
                                            "Warranty available"
                                        ].map((item, i) => (
