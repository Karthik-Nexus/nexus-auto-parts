        ...
        <div className="min-h-screen bg-neutral-50 font-sans text-slate-800 overflow-x-hidden w-full max-w-full">
            ...
            <main className="w-full px-4 py-12 lg:py-16 max-w-4xl mx-auto space-y-8">
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <ul className="space-y-2 text-slate-600">
                            ...
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                                Incorrect parts sent by Nexus Used Auto Parts LLC
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-primary font-bold">•</span>
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <p className="text-slate-600">
                            Nexus Used Auto Parts LLC is not responsible for shipments marked delivered by the carrier to the address provided but not received by the customer.
                        </p>
                        <div className="bg-slate-50 p-4 rounded-lg">
