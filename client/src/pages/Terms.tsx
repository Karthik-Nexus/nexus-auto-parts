        ...
        <div className="min-h-screen bg-neutral-50 font-sans text-slate-800 overflow-x-hidden w-full max-w-full">
            ...
            <main className="w-full px-4 py-12 lg:py-16 max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className="text-slate-600">Terms governing SMS communications from Nexus Used Auto Parts LLC</p>
                </div>
                    ...
                    <CardContent className="p-6 space-y-4">
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg border-l-4 border-slate-300">
                            <p className="text-slate-600 text-sm italic">
                                <strong>Example:</strong> "Hello, this is a friendly reminder regarding the Part you requested [Year: XYZ Make: XYZ Model: XYZ] with Nexus Used Auto Parts LLC. Please call 866-317-1665 for further help. Reply STOP to opt out of SMS messaging at any time."
                            </p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-lg">
                    ...
                    <CardContent className="p-6 space-y-4">
                        ...
                        <a href="https://www.nexususedautoparts.com" className="text-primary font-medium hover:underline block">
